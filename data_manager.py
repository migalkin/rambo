...
from load import load_fb15k237, load_fb15k, \
    load_jf17k_statements, load_jf17k_quints, load_jf17k_triples, \
    load_wikipeople_statements, load_wikipeople_quints, load_wikipeople_triples, \
    load_wd15k_statements, load_wd15k_quints, load_wd15k_triples, \
    load_wd15k_qonly_statements, load_wd15k_qonly_quints, load_wd15k_qonly_triples, \
    load_wd15k_qonly_66_statements, load_wd15k_qonly_66_quints, load_wd15k_qonly_66_triples, \
    load_wd15k_qonly_33_statements, load_wd15k_qonly_33_quints, load_wd15k_qonly_33_triples, \
...
class DataManager(object):
    ...
    def load(config: Union[dict, FancyDict]) -> Callable:
        ...
        elif config['DATASET'] == 'tkbc':
            return partial(load_tkbc, name="tkbc")
        elif config['DATASET'] == 'yago15k':
            return partial(load_tkbc, name="yago15k")
        elif config['DATASET'] == 'icews14':
