...
from load import _get_uniques_, _pad_statements_, count_stats

def load_clean_wikipeople_statements(maxlen=17) -> Dict:
    """
...
def load_clean_jf17k_statements(maxlen=15) -> Dict:
